...
{
    public class TimedEventViewModel : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return
                    new ValidationResult( "To Date must be greater than From Date");
            }
            else if (ToHour < FromHour)
            {
                yield return
                    new ValidationResult("To Hour must be greater than From Hour");
            }
